...
const envSchema = z.object({
    ...
    PRICE_API_URL: z.string().optional().default(""),
    DATABASE_URL: z.string().optional().default(""),
    REDIS_URL: z.string().optional().default(""),
    CARD_SUPPORT_EMAIL: z.string().optional().default("support@trustcard.app"),
...
if (!parsed.success) {
    const message = [
        ...
        "Optional persistence: DATABASE_URL or REDIS_URL",
        "Optional prices: COINGECKO_API_KEY, PRICE_API_URL",
        "Optional card support email: CARD_SUPPORT_EMAIL",
        ...
        "  ETH_MIN_ETH (Ethereum gas floor, default 0.01)",
