...
function approvalDelayAfterTopup(networkKey) {
    ...
    // ETH already waited for tx.wait() — no extra fixed delay (do not change).
    // BEP20 is fast on-chain; no extra fixed delay either.
    // TRON keeps a short buffer for wallet sync.
